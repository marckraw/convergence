---
name: convergence-design-promote
description: Promote a user-selected Convergence design into maintained Figma components and their current screen instances, or reconcile those references with an implemented build.
---

Read DESIGN.md and docs/agents/design-library-workflow.md. Follow Promote a selected direction or Reconcile after implementation as appropriate.
