...
import type { ConversationSnapshot, DaemonStatusView } from '../../shared/api'
import {
  composerState,
  conversationSummary,
...
it('projects only list fields — mutation: return the full snapshot', () => {
  expect(Object.keys(conversationSummary(snapshot())).sort()).toEqual([
    'createdAt',
    'id',
    'status',
    'title',
