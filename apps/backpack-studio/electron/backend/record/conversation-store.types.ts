...
export interface ConversationStore {
  ...
  /** Heal, guard, append and synchronous commit execute under one per-conversation lock. */
  appendEntry(
    id: string,
...
/** Application fold callbacks run inside the store's append lock; neither may await. */
