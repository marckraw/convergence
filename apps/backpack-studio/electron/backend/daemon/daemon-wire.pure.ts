...
import type { DaemonStatusView } from '../../../src/shared/api/studio-api.types'
 ...
 * release.
 *
 * This wire construction also exists in Convergence's execution host.
 * RUN50 R2 retains the reviewed Studio client as designed; shared wire
 * extraction is a separate run, outside this lane's apps/convergence boundary.
 */
