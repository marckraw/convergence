 ...
 *
 * `crews` was a third, and it retired with R13 (RUN45): every capability it
 ...
 *
 * `waves` was a third until MAR-3233: the tracker's ledger is Loom's to
 * show, beside the conversation, and a stored `waves` reads as the default
 * mode — the parse law: no stored value leaves a person without a view.
 */
