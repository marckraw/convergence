export const barClass =
  'app-global-status-bar flex h-7 shrink-0 items-center gap-3 border-t border-white/10 bg-card/40 px-3 text-[11px] text-muted-foreground backdrop-blur-sm'

export const zoneClass = 'flex min-w-0 items-center gap-2'

export const aggregateChipClass =
  'flex items-center gap-1 rounded-md border border-border/50 bg-background/40 px-1.5 py-0.5'
...
export const dotClass = 'inline-block h-1.5 w-1.5 rounded-full'
