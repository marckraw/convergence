...
The conversation pilot starts at page `594:2821`. Activity body set `594:2822`, project card set `594:4095`, activity composition set `597:38613` (default `595:1294`), review actions `595:1284`.
