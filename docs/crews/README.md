...
lane name and reference their root project’s origin key or name. Global roles use `project: null`.
...
only the inverse for the C1 round-trip canary; it is not a validation or import API. The schema
